...
public class TestUrl {
	...
	public void setUp() throws Exception {
		mydriver = new FirefoxDriver(salt.domcoverage.core.dom.proxy.BrowserProfile.getProfile());
	...
	public void tearDown() throws Exception {
		((JavascriptExecutor) mydriver).executeScript("		if (window.jscoverage_report) {return jscoverage_report('report');}");
