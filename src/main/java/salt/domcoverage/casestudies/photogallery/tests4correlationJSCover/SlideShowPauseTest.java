...
public class SlideShowPauseTest {
	...
	public void setUp() throws Exception {
		...
		baseUrl = "localhost:8888/phormer-photoGallery331/?feat=slideshow";
	...
	public void tearDown() throws Exception {
		salt.domcoverage.core.utils.Utils.jSCoverLocalStor(driver, this.getClass().getName());driver.quit();
