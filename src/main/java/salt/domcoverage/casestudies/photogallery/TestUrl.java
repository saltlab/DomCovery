...
public class TestUrl {
    ...
    public void testStoringHitsValue() throws Exception {
        ...
        WebElement findElement = mydriver.findElement(salt.domcoverage.core.code2instrument.DomCoverageClass.collectData(By.xpath(xpathExpression), mydriver, this.getClass().getName()+"."+new Object(){}.getClass().getEnclosingMethod().getName()));
    }
