...
public class TestUrl {
    ...
    public void setUp() throws Exception {
        mydriver = new FirefoxDriver(salt.domcoverage.core.dom.proxy.BrowserProfile.getConfigureProxyandgetProfile());
    ...
    public void testStoringHitsValue() throws Exception {
        ...
        WebElement findElement = mydriver.findElement(salt.domcoverage.core.code2instrument.DomCoverageClass.collectData(By.xpath(xpathExpression), mydriver, this.getClass().getName() + "." + new Object() {
    ...
    private boolean isElementPresent(By by) {
        try {
            mydriver.findElement(salt.domcoverage.core.code2instrument.DomCoverageClass.collectData(by, mydriver, this.getClass().getName() + "." + new Object() {
            }.getClass().getEnclosingMethod().getName()));
            return true;
