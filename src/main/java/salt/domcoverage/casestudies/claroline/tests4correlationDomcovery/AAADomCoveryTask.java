...
public class AAADomCoveryTask {
	...
	public static void main(String argv[]) {
		...
		for (int i = 0; i < testClassNames.size(); i++) {
			coverageforTestClasses(testClassNames.subList(i, i + 1));
	...
	private static void coverageforTestClasses(List<String> testClassNames) {
		String outName = "" + counter++;
		// ConstantVars.Clickable_element_collection =true;
		String testLocationFolder = System.getProperty("user.dir") + "/src/main/java/salt/domcoverage/casestudies/claroline/tests4correlationDomcoveryInstrumented/";
