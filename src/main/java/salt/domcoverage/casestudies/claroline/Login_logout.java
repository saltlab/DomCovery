...
public class Login_logout {
    ...
    public void testLoginLogout() throws Exception {
        ...
        try {
            ...
            }.getClass().getEnclosingMethod().getName()), driver.getPageSource(), this.getClass().getName()+"."+new Object(){}.getClass().getEnclosingMethod().getName())).getText().matches("^[\\s\\S]*Authentication[\\s\\S]*$"));
        } catch (Error e) {
