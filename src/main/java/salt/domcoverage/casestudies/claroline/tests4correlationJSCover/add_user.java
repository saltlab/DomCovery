package salt.domcoverage.casestudies.claroline.tests4correlationJSCover;
...
public class add_user {
	...
	public void testAddUser() throws Exception {
		...
		driver.findElement(By.id("lastname")).sendKeys("Naman1");
		driver.findElement(By.id("firstname")).clear();
		driver.findElement(By.id("firstname")).sendKeys("Agr1");
		driver.findElement(By.id("officialCode")).clear();
		driver.findElement(By.id("officialCode")).sendKeys("a7");
		driver.findElement(By.id("username")).clear();
		driver.findElement(By.id("username")).sendKeys("nam1");
		driver.findElement(By.id("username")).clear();
		driver.findElement(By.id("username")).sendKeys("naman1");
		driver.findElement(By.id("password")).clear();
