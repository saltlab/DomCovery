...
public class Manage {
	...
	public void testManage() throws Exception {
		...
		driver.findElement(salt.domcoverage.core.code2instrument.DomCoverageClass.collectData(By.linkText("Manage administrator email notifications"), driver.getPageSource(), this.getClass().getName() + "." + new Object() {
		}.getClass().getEnclosingMethod().getName())).click();
		...
		try {
			...
			}.getClass().getEnclosingMethod().getName())).getText().matches("^[\\s\\S]*System mail : recipients list[\\s\\S]*$"));
		} catch (Error e) {
