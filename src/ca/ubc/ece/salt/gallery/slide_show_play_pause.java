...
public class slide_show_play_pause {
  ...
  public void testSlideShowPlayPause() throws Exception {
    ...
    new Select(driver.findElement(By.id("ss_refresh"))).selectByVisibleText("regexp:\\s5 Sec");
    driver.findElement(By.id("ss_playpause_link2")).click();
  }
